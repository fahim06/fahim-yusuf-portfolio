...
export const projects = [
  {
    name: "FocusFlow",
    description: "AI-Powered Study & Focus App. Adaptive study planning with energy-based AI recommendations for optimal productivity.",
    language: "HTML/JS",
  ...
  },
  {
    ...
    description: "Brain tumor identification system using deep learning (VGG-16) achieving 95.21% accuracy. B.Sc. thesis project.",
    language: "Jupyter Notebook",
    tags: ["Deep Learning", "VGG-16", "Medical AI", "TensorFlow"],
  ...
  },
  {
    ...
    description: "Comprehensive student management system with full CRUD operations, reporting, and a clean dashboard interface.",
    language: "HTML",
    tags: ["Web App", "CRUD", "Django", "PostgreSQL"],
  ...
  },
  {
    ...
    description: "A beautifully animated login page with smooth transitions, glassmorphism effects, and modern CSS animations.",
    language: "CSS",
